...
<body class="form-v4">
	<div class="page-content">
		<div class="form-v4-content">
			<div class="form-left">
				<h2>INFOMATION</h2>
				<p class="text-1">Hệ thống lên lịch tự động gửi email hàng loạt.</p>
				...
				<div class="form-left-last">
					<input type="submit" name="account" class="account" value="Have An Account">
	                    ...
	                    <form class="form-detail" role="form" method="post"  action="<?=base_url()?>authentication/login/">
				<h2>LOGIN FORM</h2>
				...
				<a href="http://localhost/authentication/reg" class="text">REGISTER</a>
			</form>
		</div>
	</div>
